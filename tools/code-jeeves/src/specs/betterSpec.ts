    ...
    cause: z
      .union([
        z
          .literal("specified")
          .describe(
            "this user story is a direct result of the specification given by the user",
          ),
        z
          .literal("optional")
          .describe(
            "this user story is a result of the system infering potential additional requirements",
          ),
        z
          .literal("critical")
          .describe(
            "this user story is a result of the system identifying critical requirements",
          ),
...
export const Epic = z
  ...
  .describe(
    "An Epic is describing a task or bunsiness process on a high level. It must contain a full description of what to do in this context. This will later be used to create user stories",
  );
...
const BoundedContext = z.object({
  ...
  description: z
    .string()
    .describe("a brief description of the bounded context"),
  epics: Epic.array(),
  relations: z
    .string()
    .array()
    .describe(
      "A list of other bounded contexts in the domain, this bounded context relates to",
    ),
});
