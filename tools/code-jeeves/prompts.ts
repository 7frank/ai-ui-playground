...
const documentCodePrompt = "Document the following source code and functions. Make sure that every function has a proper comment block."; //
...
const optimizeCode = "Optimize the following source code and functions. Comment code that is not used out.";
