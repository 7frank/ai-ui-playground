...
import developerDiagram from './developer-workflow.puml';
import uiDiagram from './ui-workflow.puml';
...
<table>
  <tr>
    <td>
      <img alt="" src={developerDiagram} />
    </td>
    <td>
      <img alt="" src={uiDiagram} /></td>
  </tr>
</table>
...
[see results](../GUI-Generator/index.mdx)
...
Uses ai to generate sitemap from prompts, then export to figma or similar

- https://library.relume.io/ai-site-builder

- are there similar open source tools?
- looks good but limited free tier
