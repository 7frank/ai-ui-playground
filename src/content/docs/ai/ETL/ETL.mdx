...
- **Data Collection**: Gathering raw data from various sources such as [databases](../Databases.md), files, online sources, or sensors.
  - *Tools*: SQL databases, [Web scraping tools](./WebScraping.md) (like BeautifulSoup), APIs, IoT sensors
...
In depth article explaining [How to Build ETL Data Pipeline in ML](https://neptune.ai/blog/build-etl-data-pipeline-in-ml)
