...
import rolesTransitionMatrix from './Roles_Transition.csv.txt';
import rolesSeniorityMatrix from './Roles_Seniority_Matrix.csv.txt';
...
<Table client:only src={rolesTransitionMatrix} />
