...
<IFrameBox client:only 
 src="https://blinpete.github.io/wiki-graph/?lang=en&wordle=&query=Machine%20learning"
 maxStyle="" 
 style=""
/>
...
Explore the Graph above by entering your own terms e.g.:
...
<IFrameBox client:only 
 src="https://blinpete.github.io/wiki-graph/?lang=en&wordle=&query=Deep_learning"
 maxStyle="" 
 style=""
/>
