...
<BigBox client:only maxStyle="width: 80%; height: 80%">
    <iframe src="https://blinpete.github.io/wiki-graph/?lang=en&wordle=&query=Machine%20learning" width="100%" height="100%"></iframe>  
</BigBox>
